    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 pull-left">
                ...
                <!-- <a href="#" onclick="window.open('https://www.sitelock.com/verify.php?site=balash.com.br','SiteLock','width=600,height=600,left=160,top=170');" ><img class="img-responsive" alt="SiteLock" title="SiteLock" src="//shield.sitelock.com/shield/balash.com.br" /></a> --></div>
