    ...
    <div class="panel-body">
      ...
      <div class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" maxlength="8" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control" />
          </div>
        </div>
        ...
        <button type="button" id="button-quote" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary pull-right"><?php echo $button_quote; ?></button>
      </div>
      <script type="text/javascript">
        ...
        window.ukd_fn.push(function() {
          ...
          $('select[name=\'zone_id\']').change(function(event) {
            ...
            ?>
            getAddressByPostcode('#collapse-shipping', false)
