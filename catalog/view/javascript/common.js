            ...
            success: function(json) {
                ...
                if (json['success']) {
                    ...
                    setTimeout(function() {
                        ...
                        //$('#cart > button').html('<i class="fa fa-shopping-bag" style="font-size:30px"></i> <span id="cart-total" class="label label-success label-as-badge"> ' + json['count_products'] + '</span>');
                    }, 100);
