...
class ModelCheckoutOrder extends Model
{
    ...
    public function addCustomData($order_id, $link)
    {
        $this->db->query('INSERT INTO '.DB_PREFIX.'order_custom_field SET order_custom_field_id = NULL, order_id='.(int) $order_id.", custom_field_id = 1, custom_field_value_id = 1 , name = 'permanent_link', value = '".$this->db->escape($link)."', type = 'text', location = ''");
    }
    ...
    public function addOrderHistory($order_id, $order_status_id, $comment = '', $notify = false, $override = false, $tracking_number = '')
    {
      ...
      $this->db->query('INSERT INTO '.DB_PREFIX."order_history SET order_id = '".(int) $order_id."', order_status_id = '".(int) $order_status_id."', notify = '".(int) $notify."', comment = '".$this->db->escape($comment)."', date_added = NOW()" . ", tracking_number= '$tracking_number'");
