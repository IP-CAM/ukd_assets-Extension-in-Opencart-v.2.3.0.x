...
--------------------------------------------------------------------------------
   ...
   Filename  : ukd_pagseguro\upload\system\library\ukd_pagseguro_app\templates\buyerData.inc.php
   Author    : Fred Ukita
...
--><div class="groupData" id="buyerData">
	...
	<div class="field">
		<label for="senderCPF">CPF (somente n̼meros)</label>
	...
	<div class="field">
		<label for="shippingAddressPostalCode">CEP (somente n̼meros)</label>
